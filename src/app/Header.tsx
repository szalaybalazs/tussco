...
const Header: FunctionComponent<iHeaderProps> = () => {
  return (
    <header className="flex flex-shrink-0 px-4 md:px-0 bg-white z-50 sticky top-0 items-center max-w-4xl mx-auto w-full border-b border-gray-300 dark:border-gray-600 h-[80px] dark:bg-gray-800">
